...
class LibrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create libro" do
    assert_difference('Libro.count') do
      post libros_url, params: { libro: { autor: @libro.autor, cod_dewey: @libro.cod_dewey, fecha_pub: @libro.fecha_pub, titulo: @libro.titulo } }
    end
  ...
  test "should update libro" do
    patch libro_url(@libro), params: { libro: { autor: @libro.autor, cod_dewey: @libro.cod_dewey, fecha_pub: @libro.fecha_pub, titulo: @libro.titulo } }
